...
__all__ = ['ModelAgnosticMetaLearning', 'MAML', 'FOMAML', 'SamMaml']


class SamModelAgnosticMetaLearning(object):
...
SamMAML = SamModelAgnosticMetaLearning

class SamFOMAML(SamModelAgnosticMetaLearning):
    def __init__(self, model, optimizer=None, step_size=0.1,
                 learn_step_size=False, per_param_step_size=False,
                 num_adaptation_steps=1, scheduler=None,
                 loss_function=F.cross_entropy, device=None):
        super(SamFOMAML, self).__init__(model, optimizer=optimizer, first_order=True,
